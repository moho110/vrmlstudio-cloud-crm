...
/**
 * 固定资产出库对象 cmf_fixedassetout
 * 
 * @author VRer
 * @date 2022-04-15
 */
public class CmfFixedassetout extends BaseEntity
{
    ...
    /** $column.columnComment */
    @Excel(name = "${comment}", readConverterExp = "$column.readConverterExp()")
    private String jielingcondition;

    /** $column.columnComment */
    @Excel(name = "${comment}", readConverterExp = "$column.readConverterExp()")
    private String jielingman;
    ...
    public void setJielingcondition(String jielingcondition) 
    {
        this.jielingcondition = jielingcondition;
    }

    public String getJielingcondition() 
    {
        return jielingcondition;
    }
    public void setJielingman(String jielingman) 
    {
        this.jielingman = jielingman;
    }

    public String getJielingman() 
    {
        return jielingman;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("jielingcondition", getJielingcondition())
            .append("jielingman", getJielingman())
