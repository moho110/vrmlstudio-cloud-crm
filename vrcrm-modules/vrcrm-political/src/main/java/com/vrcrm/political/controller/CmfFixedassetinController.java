...
public class CmfFixedassetinController extends BaseController
{
     ...
     * 查询固定资产入库列表
     */
    @PreAuthorize("@ss.hasPermi('political:fixedassetin:list')")
    @GetMapping("/list")
     ...
     * 导出固定资产入库列表
     */
    @PreAuthorize("@ss.hasPermi('political:fixedassetin:export')")
     ...
     * 获取固定资产入库详细信息
     */
    @PreAuthorize("@ss.hasPermi('political:fixedassetin:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增固定资产入库
     */
    @PreAuthorize("@ss.hasPermi('political:fixedassetin:add')")
     ...
     * 修改固定资产入库
     */
    @PreAuthorize("@ss.hasPermi('political:fixedassetin:edit')")
     ...
     * 删除固定资产入库
     */
    @PreAuthorize("@ss.hasPermi('political:fixedassetin:remove')")
