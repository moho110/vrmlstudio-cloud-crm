 ...
 */
@RestController
@RequestMapping("/officeproductleibie")
public class CmfOfficeproductleibieController extends BaseController
{
     ...
     * 查询办公用品类别列表
     */
    @PreAuthorize("@ss.hasPermi('political:officeproductleibie:list')")
    @GetMapping("/list")
     ...
     * 导出办公用品类别列表
     */
    @PreAuthorize("@ss.hasPermi('political:officeproductleibie:export')")
     ...
     * 获取办公用品类别详细信息
     */
    @PreAuthorize("@ss.hasPermi('political:officeproductleibie:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增办公用品类别
     */
    @PreAuthorize("@ss.hasPermi('political:officeproductleibie:add')")
     ...
     * 修改办公用品类别
     */
    @PreAuthorize("@ss.hasPermi('political:officeproductleibie:edit')")
     ...
     * 删除办公用品类别
     */
    @PreAuthorize("@ss.hasPermi('political:officeproductleibie:remove')")
