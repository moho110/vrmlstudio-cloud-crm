...
public class VrCrmMytableApplication
{
    public static void main(String[] args)
    {
        SpringApplication.run(VrCrmMytableApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  我的办公桌模块启动成功   ლ(´ڡ`ლ)ﾞ  \n" +
                " .-------.       ____     __        \n" +
                " |  _ _   \\      \\   \\   /  /    \n" +
                " | ( ' )  |       \\  _. /  '       \n" +
                " |(_ o _) /        _( )_ .'         \n" +
