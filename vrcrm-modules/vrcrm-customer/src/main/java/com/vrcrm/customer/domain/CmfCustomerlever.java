...
/**
 * 客户等级对象 cmf_customerlever
 * 
 * @author VRer
 * @date 2022-04-15
 */
public class CmfCustomerlever extends BaseEntity
{
    ...
    public void setRelateprice(String relateprice) 
    {
        this.relateprice = relateprice;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("relateprice", getRelateprice())
            .toString();
    }
}
