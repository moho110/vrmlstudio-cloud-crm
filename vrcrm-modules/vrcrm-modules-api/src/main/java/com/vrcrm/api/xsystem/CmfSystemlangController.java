...
@RestController
@RequestMapping("/api")
public class CmfSystemlangController {
    ...
    @GetMapping(value = "/xsystem/systemlang/find/{id}")
    public ResponseEntity<Object> find(@PathVariable("id") Integer id) throws IOException {
        return new ResponseEntity<>(cmfSystemlangService.selectCmfSystemlangById(id), HttpStatus.OK);
    }
    ...
    @GetMapping(value = "/xsystem/systemlang/info/")
    public ResponseEntity<Object> info(CmfSystemlang cmfSystemlang) throws IOException{
        return new ResponseEntity<>(cmfSystemlangService.selectCmfSystemlangList(cmfSystemlang), HttpStatus.OK);
    }
}