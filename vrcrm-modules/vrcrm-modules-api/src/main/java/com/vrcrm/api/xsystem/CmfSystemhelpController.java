...
@RestController
@RequestMapping("/api")
public class CmfSystemhelpController {
    ...
    @GetMapping(value = "/xsystem/systemhelp/find/{id}")
    public ResponseEntity<Object> find(@PathVariable("id") Integer id) throws IOException {
        return new ResponseEntity<>(cmfSystemhelpService.selectCmfSystemhelpById(id), HttpStatus.OK);
    }
    ...
    @GetMapping(value = "/xsystem/systemhelp/info/")
    public ResponseEntity<Object> info(CmfSystemhelp CmfSystemhelp) throws IOException{
        return new ResponseEntity<>(cmfSystemhelpService.selectCmfSystemhelpList(CmfSystemhelp), HttpStatus.OK);
    }
}