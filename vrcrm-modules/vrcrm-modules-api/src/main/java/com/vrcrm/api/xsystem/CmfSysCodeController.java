...
@RestController
@RequestMapping("/api")
public class CmfSysCodeController {
    ...
    @GetMapping(value = "/xsystem/syscode/find/{id}")
    public ResponseEntity<Object> find(@PathVariable("id") Integer id) throws IOException {
        return new ResponseEntity<>(cmfSysCodeService.selectCmfSysCodeById(id), HttpStatus.OK);
    }
    ...
    @GetMapping(value = "/xsystem/syscode/info/")
    public ResponseEntity<Object> info(CmfSysCode cmfSysCode) throws IOException{
        return new ResponseEntity<>(cmfSysCodeService.selectCmfSysCodeList(cmfSysCode), HttpStatus.OK);
    }
}