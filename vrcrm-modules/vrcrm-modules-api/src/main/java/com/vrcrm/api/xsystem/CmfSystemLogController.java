...
@RestController
@RequestMapping("/api")
public class CmfSystemLogController {
    ...
    @GetMapping(value = "/xsystem/systemlog/find/{id}")
    public ResponseEntity<Object> find(@PathVariable("id") Integer id) throws IOException {
        return new ResponseEntity<>(cmfSystemLogService.selectCmfSystemLogById(id), HttpStatus.OK);
    }
    ...
    @GetMapping(value = "/xsystem/systemlog/info/")
    public ResponseEntity<Object> info(CmfSystemLog cmfSystemLog) throws IOException{
        return new ResponseEntity<>(cmfSystemLogService.selectCmfSystemLogList(cmfSystemLog), HttpStatus.OK);
    }
}