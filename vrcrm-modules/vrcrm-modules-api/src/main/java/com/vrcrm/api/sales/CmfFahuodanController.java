...
@RestController
@RequestMapping("/api")
public class CmfFahuodanController {
    ...
    @GetMapping(value = "/sales/fahuodan/find/{id}")
    public ResponseEntity<Object> find(@PathVariable("id") Integer id) throws IOException {
        return new ResponseEntity<>(cmfFahuodanService.selectCmfFahuodanById(id), HttpStatus.OK);
    }
    ...
    @GetMapping(value = "/sales/fahuodan/info/")
    public ResponseEntity<Object> info(CmfFahuodan cmfFahuodan) throws IOException{
        return new ResponseEntity<>(cmfFahuodanService.selectCmfFahuodanList(cmfFahuodan), HttpStatus.OK);
    }
}