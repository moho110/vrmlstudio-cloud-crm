...
@RestController
@RequestMapping("/api")
public class CmfWuBooleanController {
    ...
    @GetMapping(value = "/political/wuboolean/find/{id}")
    public ResponseEntity<Object> find(@PathVariable("id") Integer id) throws IOException {
        return new ResponseEntity<>(cmfWuBooleanService.selectCmfWuBooleanById(id), HttpStatus.OK);
    }
    ...
    @GetMapping(value = "/political/wuboolean/info/")
    public ResponseEntity<Object> info(CmfWuBoolean cmfWuBoolean) throws IOException{
        return new ResponseEntity<>(cmfWuBooleanService.selectCmfWuBooleanList(cmfWuBoolean), HttpStatus.OK);
    }
}