...
@RestController
@RequestMapping("/api")
public class CmfStockController {
    ...
    @GetMapping(value = "/store/stock/find/{id}")
    public ResponseEntity<Object> find(@PathVariable("id") Integer id) throws IOException {
        return new ResponseEntity<>(cmfStockService.selectCmfStockById(id), HttpStatus.OK);
    }
    ...
    @GetMapping(value = "/store/stock/info/")
    public ResponseEntity<Object> info(CmfStock cmfStock) throws IOException{
        return new ResponseEntity<>(cmfStockService.selectCmfStockList(cmfStock), HttpStatus.OK);
    }
}