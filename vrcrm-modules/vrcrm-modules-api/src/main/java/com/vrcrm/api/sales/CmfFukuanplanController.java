...
@RestController
@RequestMapping("/api")
public class CmfFukuanplanController {
    ...
    @GetMapping(value = "/sales/fukuanplan/find/{id}")
    public ResponseEntity<Object> find(@PathVariable("id") Integer id) throws IOException {
        return new ResponseEntity<>(cmfFukuanplanService.selectCmfFukuanplanById(id), HttpStatus.OK);
    }
    ...
    @GetMapping(value = "/sales/fukuanplan/info/")
    public ResponseEntity<Object> info(CmfFukuanplan cmfFukuanplan) throws IOException{
        return new ResponseEntity<>(cmfFukuanplanService.selectCmfFukuanplanList(cmfFukuanplan), HttpStatus.OK);
    }
}