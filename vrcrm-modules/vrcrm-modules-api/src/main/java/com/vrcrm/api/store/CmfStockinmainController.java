...
@RestController
@RequestMapping("/api")
public class CmfStockinmainController {
    ...
    @GetMapping(value = "/store/stockinmain/find/{id}")
    public ResponseEntity<Object> find(@PathVariable("id") Integer id) throws IOException {
        return new ResponseEntity<>(cmfStockinmainService.selectCmfStockinmainById(id), HttpStatus.OK);
    }
