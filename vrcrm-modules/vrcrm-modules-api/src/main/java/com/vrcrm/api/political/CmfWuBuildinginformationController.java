...
@RestController
@RequestMapping("/api")
public class CmfWuBuildinginformationController {
    ...
    @GetMapping(value = "/political/wubuildinginformation/find/{id}")
    public ResponseEntity<Object> find(@PathVariable("id") Integer id) throws IOException {
        return new ResponseEntity<>(cmfWuBuildinginformationService.selectCmfWuBuildinginformationById(id), HttpStatus.OK);
    }
     ...
     * uniapp端调用
     *
     * @param cmfWuBuildinginformation
     * @return
     */
    @ApiResponse(code = 400, message = "获取帐号操作列表失败")
    @ApiOperation(value = "帐号操作列表", notes = "获取帐号操作列表")
    @GetMapping(value = "/political/wubuildinginformation/info/")
    public ResponseEntity<Object> info(CmfWuBuildinginformation cmfWuBuildinginformation) throws IOException{
        return new ResponseEntity<>(cmfWuBuildinginformationService.selectCmfWuBuildinginformationList(cmfWuBuildinginformation), HttpStatus.OK);
    }
}